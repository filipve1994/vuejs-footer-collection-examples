...
const items = [

    {
        ...
        entry: {
            folderPath: './tools/templates/vue/__component__Component.vue',
        },
...

    {
        ...
        stringReplacers: ['__component__'],
        output: {
            path: './src/components/__component__(lowerCase)/__component__(pascalCase).vue',
            pathAndFileNameDefaultCase: '(pascalCase)',
        },
        onComplete: (results) => {
            console.log(`results`, results);
...

    {
        ...
        defaultCase: '(pascalCase)',
        entry: {
            folderPath: './tools/templates/vue/__view__View.vue',
        },
